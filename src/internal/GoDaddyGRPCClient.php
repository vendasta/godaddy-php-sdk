...
class GoDaddyGRPCClient extends GRPCClient implements GoDaddyClientInterface
{
    ...
    public function GetDomainSuggestionAndPrice(\Godaddy\V1\GetDomainSuggestionAndPriceRequest $req, array $options = []): \Godaddy\V1\GetDomainSuggestionAndPriceResponse
    {
        return $this->doRequest(
            array($this->client, 'GetDomainSuggestionAndPrice'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'PutDNSRecord'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'DeleteDNSRecord'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'GetDomainAgreements'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'ValidateDomainContact'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'ListDomainsByBusinessID'),
            $req,
            $options
        );
    }
    ...
    {
        return $this->doRequest(
            array($this->client, 'TransferDomain'),
            $req,
            $options
        );
    }
